...
| Vulnerability management | Plan documented; operations not validated | Private intake, severity targets, remediation and verification stages, evidence minimization, and time-bounded exception rules are documented; operating metrics, exercises, and independent review remain pending |
