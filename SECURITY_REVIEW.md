...
| Private application license inventory | One production component confirmed; distribution blocked | A machine-readable SBOM, third-party inventory, artifact trace, and 11-row review worksheet are retained privately. Automated evidence confirms one flagged component in emitted browser JavaScript and identifies ten development/build paths; notice packaging, exclusion checks, and every qualified legal disposition remain open before distributing application source or binaries |
