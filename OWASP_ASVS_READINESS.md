...
| Communications security | HTTPS hosting and a restrictive Content Security Policy are designed into the deployment | Partially evidenced | Capture live TLS and security-header evidence and test downgrade/failure behavior | Operations owner |
