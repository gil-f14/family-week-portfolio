...
| [NIST SP 800-218 SSDF 1.1](https://csrc.nist.gov/pubs/sp/800/218/final) | Partially aligned | Pinned dependencies, integrity-checked OCR assets, reviewed changes, automated tests, build gates, baseline threat model, private SBOM, deterministic evidence checksums, documented release rules, and a severity-based vulnerability-management plan | Qualified provenance validation, operating response evidence, license resolution, and independent security testing |
