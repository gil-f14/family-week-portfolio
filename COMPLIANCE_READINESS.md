...
| [WCAG 2.2 Level AA](https://www.w3.org/TR/WCAG22/) | Target; near-ready engineering controls | Semantic dialog behavior, focus trapping/restoration, Escape close, full event-date labels, live status/alert roles, responsive viewport containment, touch-sized controls, reduced-motion handling, and no forced autofocus | Full-page automated audit plus manual keyboard, screen-reader, contrast, 200%/400% zoom, reflow, orientation, motion-preference, and supported-browser testing; remediate all A/AA failures before a conformance claim |
