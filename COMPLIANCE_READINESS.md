...
| --- | --- | --- | --- |
| [NIST Cybersecurity Framework 2.0](https://www.nist.gov/publications/nist-cybersecurity-framework-csf-20) | Partially aligned | Governance rules, data boundaries, least privilege, protective controls, failure states, rollback, and a product-level current/target engineering profile map across Govern, Identify, Protect, Detect, Respond, and Recover | Formal organizational profile, approved risk tolerance, operating evidence, and independent review |
...
| [NIST Privacy Framework 1.0](https://www.nist.gov/privacy-framework) | Partially aligned | Data inventory, processing boundaries, minimization, user review, private-by-default operation, release gates, and a product-level current/target engineering profile | Privacy-impact assessment, deletion policy, notices, operating evidence, and independent review; monitor revisions without claiming a draft as final |
...
| [OWASP ASVS 5.0.0](https://owasp.org/www-project-application-security-verification-standard/) | Not assessed | Authentication, session, validation, CSP, access-control, and safe-error controls provide starting evidence | Select an ASVS level, build a requirement-by-requirement verification matrix, test it, and resolve gaps before citing ASVS alignment |
