...
| Week 2 | Security and privacy evidence | Exercise the vulnerability-management plan, obtain qualified approval of the assembled notice candidate, use the completed exact-build identifier scan as supporting evidence, confirm exclusion of ten flagged development/build paths from the exact release archive, complete disposition of the 11-row license worksheet, and independently review the baseline and privacy-impact assessment | No unresolved critical/high finding; response evidence, distribution obligations, and retention decisions documented |
