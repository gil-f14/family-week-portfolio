...
The current automated release gate passes 105 tests, including reduced-motion behavior, accessibility source guards, calendar safety boundaries, privacy controls, generated-artifact privacy and file-type checks, supply-chain evidence freshness, threat-model coverage, fail-closed content-free monitoring validation, and synthetic OCR evaluation criteria. This evidence does not replace the human checks below.
